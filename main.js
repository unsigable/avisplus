let currentPage = 'home';
        ...
        document.querySelector('form').addEventListener('submit', function() {
            ...
            successMsg.style.cssText = `
                ...
                z-index: 10000;
            `;
            successMsg.textContent = 'Спасибо! Ваше сообщение доставлено!';
            document.body.appendChild(successMsg);
            setTimeout(() => { successMsg.remove(); }, 3000);
        
            // Сбрасываем форму через короткую задержку (500 мс), чтобы данные успели уйти
...
// ==============================
// Bottom navigation menu JS
// ==============================
const bottomLinks = document.querySelectorAll('.bottom-navigation .list');
...
// Клик по меню (добавляет active для анимации)
function activeBottomLink(){
    bottomLinks.forEach(item => item.classList.remove('active'));
    this.classList.add('active');
}

bottomLinks.forEach(item =>
    item.addEventListener('click', activeBottomLink)
);
